...
now we will directly create a dashboard using actual data. The [dataset](https://github.com/onlyphantom/brillian/blob/main/datasets/idx_daily_data.csv) can be downloaded from here. 
